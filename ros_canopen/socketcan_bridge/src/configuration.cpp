...
namespace socketcan_bridge
{
   ...
   void ConfigurationNode::callback(const can_msgs::Frame &input)
   {
      ...
      printf("\nConfigurationNode: \n\tid: 0x%X: %X %X %X %X %X %X %X %X \n", 
      output.id, output.data[0], output.data[1], output.data[2], output.data[3], 
      output.data[4], output.data[5], output.data[6], output.data[7]);
      // ROS_INFO("ConfigurationNode: \n\tid: 0x%X: %i %i %i %i %i %i %i %i", output.id, output.data[0], output.data[1], output.data[2], output.data[3], output.data[4], output.data[5], output.data[6], output.data[7]);
      // ROS_INFO("\nid: %i",output.id);
      // ROS_INFO("\n [%i, %i, %i, %i, %i, %i, %i, %i]", output.data[0], output.data[1], output.data[2], output.data[3], output.data[4], output.data[5], output.data[6], output.data[7]);
      // std::cout<<"ConfigurationNode sent: \n";
      // std::cout<<"ConfigurationNode sent: \n";
   ...
   void CollisionConfigurationNode::callback(const can_msgs::Frame &input)
   {
      ...
      output.id, output.data[0], output.data[1]);
      pub_.publish(output);
   }
